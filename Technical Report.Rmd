---
title: "Technical Report: Analyzing Factors Influencing Student Academic Success and Dropout Rates in Higher Education"
...
The transition from secondary to higher education often poses significant challenges for students, leading to academic difficulties and dropout. This phenomenon critically affects students' future prospects, institutions' reputations, and their financial stability. The research investigates the factors influencing student outcomes in higher education, utilizing statistical learning methods to predict outcomes based on various demographic, socio-economic, and academic variables collected at enrollment.

Previous studies have explored the general impacts of socio-economic status and previous academic performance on higher education outcomes. However, this investigation expands the scope by incorporating a comprehensive set of variables, including parental education levels and occupations, student's admission grades, and performance in the initial semesters of college. The primary research question addressed is: What factors are most predictive of student graduate outcomes in higher education?

# Methods

## Data Set Description

The data for this study was sourced from the UC Irvine Machine Learning Repository, containing records from the Polytechnic Institute of Portalegre, Portugal. The dataset spans from 2008-09 to 2018-19, including 4424 student records across various undergraduate degrees. The data features 36 predictors and a categorical response variable indicating student outcomes: `dropout`, `enrolled`, and `graduate`.

## Data Acquisition and Processing

The data was initially downloaded using UCI's URL and loaded into R for processing. Initial data wrangling involved checking for missing values (none found) and recoding categorical variables from numerical to factor types. Further modifications included simplifying the levels of complex categorical variables like parental qualifications and occupations into more general categories for analytical feasibility and model efficiency.

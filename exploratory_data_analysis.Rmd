...
set.seed(2000)
rf_1 <- randomForest(Target ~., train, ntree = 250, mtry = 4)
rf_1
```
...
Currently we have 29 variables. `XGBoost` only accepts numerical variables, while most of our predictors are categorical. We will pick the 11 consistenly best variables:

```{r}
best11var <- arrange(imp_rf, desc(MeanDecreaseGini))[1:11,2]
best11var
```

...
set.seed(2000)
rf_1 <- randomForest(Target ~., train, ntree = 250, mtry = 6)
rf_1
```
...
#library(caret)
#set.seed(2024)
#boostedIndex <- createDataPartition(sparse_matrix$Target, p=.8, list = FALSE, times = 1)
#boosted_train <- sparse_matrix[boostedIndex,]
#boosted_test <- sparse_matrix[-boostedIndex,]
```
